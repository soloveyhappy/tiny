...
//
#define SVN_WCREV _T("631")		//Highest committed revision number
#define SVN_WCDATE _T("2015/06/15 02:22:52")	//Date of highest committed revision
#define SVN_WCRANGE _T("651")	//Update revision range - should be a single revision for a clean production build
#define SVN_WCURL _T("http://svn.code.sf.net/p/tinycad/code/TinyCAD/trunk")		//Repository URL of the working copy
#define SVN_WCNOW _T("2016/07/04 22:50:11")		//Current system date and time
...
#define SVN_MODIFICATIONS SVN_LOCAL_MODIFICATIONS_PRESENT
#define SVN_MODIFICATIONS_POSTFIX _T("++")
#define SVN_MIXED SVN_NO_MIXED_REVISIONS
//
...
//                       this only affects 631 and 2015/06/15 02:22:52.
...
//
//631      Highest committed revision number
//2015/06/15 02:22:52     Date of highest committed revision
//    Like 2015/06/15 02:22:52 with an added strftime format after the =
//651    Update revision range
//http://svn.code.sf.net/p/tinycad/code/TinyCAD/trunk      Repository URL of the working copy
//2016/07/04 22:50:11      Current system date & time
//     Like 2016/07/04 22:50:11 with an added strftime format after the =
//
...
//
//The strftime format strings for  &  must not be longer
